...
const RegisterForm = ({ t, id, formType }: Props) => {
  ...
  const removeCategoriesHierarchy = (index: number) => {
    const tempCategories = [...categoriesHierarchy];
    tempCategories.splice(index, 1);
    setCategoriesHierarchy(tempCategories);
  };
  return (
      ...
      <div className="product-registration-inner">
        <Form form={form} onFinish={onFinish}>
          <CategorySetting
            ...
            removeCategoriesHierarchy={removeCategoriesHierarchy}
          />
