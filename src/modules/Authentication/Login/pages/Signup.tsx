...
import SignupInput from "@modules/Authentication/Login/components/SignupInput";
import { ValuesAdminSignupForm } from "@modules/Authentication/Login/interfaces";
...
const Signup = (props: Props) => {
  ...
  const onFinish = async (values: ValuesAdminSignupForm) => {
    setLoading(true);

    try {
      const { token, data } = await authApi.adminSignup(values);
